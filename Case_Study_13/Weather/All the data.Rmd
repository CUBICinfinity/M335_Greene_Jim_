...
Weather %>% 
  ggplot(aes(Day)) +
    theme_bw() +
    geom_vline(xintercept = 274.25, color = "#d1ac6c", size = 1) + # size = 1.25
    geom_point(aes(y = PRCP * (158/3.14) - 32), color = "gray40") +
    geom_line(aes(y = TMIN), color = "dodgerblue3") +
    geom_line(aes(y = TMAX), color = "brown3") +
    ...
    mapping = aes(x = 275, y = 105, label = paste("Yield:", Value), hjust = 0), size = 3) # size = 5
